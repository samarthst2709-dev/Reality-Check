...
import { Search, Sparkles, Github, Twitter, Shield } from 'lucide-react';
      ...
      <footer className="border-t border-slate-200 bg-white/50 mt-16">
        <div className="max-w-7xl mx-auto px-6 py-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4 text-sm text-slate-400">
            ...
            <a href="https://github.com/samarthst2709-dev/Reality-Check" target="_blank" rel="noopener noreferrer" className="hover:text-indigo-600 transition-colors flex items-center gap-1">
